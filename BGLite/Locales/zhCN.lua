...
do
    ...
    L["错误！禁止清除欠款"] = true
    L['剩余%s秒时出价'] = true
    L['%s、%s（%s）|cffff0000%s|r'] = true
    L['卡秒出价'] = true
    L["|cffff8000橙片"] = true
    L["|cff0070dd宝石"] = true
    L['< 按住CTRL+SHIFT隐藏此界面 >'] = true
    L["BGLite插件提醒：由于暴雪对插件UI数量的限制，本插件无法在硬核服务器使用，请你自行禁用。"] = true
    L["显示悬浮框"] = true
    L["悬浮框缩放"] = true
    L["调整悬浮框UI的大小。"] = true
    L["悬浮框层级"] = true
    L["|cff808080流拍价："] = true
    L["也有可能是你的WCL插件缺少本服务器数据包。鼠标指向一个玩家时，如果不显示WCL数据，说明就是上述问题。此问题与BGLite插件无关。"] = true
    L["保存"] = true
    L["分享"] = true
    L["导出"] = true
    L["应用"] = true
    ...
    L['流拍装备卖店总价：%s金'] = true
    L["搜索装备/买家/金额"] = true
    L["|cffff0000（插件被你禁用了）"] = true
    L["禁止NDui插件交易时自动打开背包"] = true
    L["对方欠款记录："] = true
    L["重复交易工资提醒："] = true
    L["交易金额超上限提醒："] = true
    L["交易后台提醒："] = true
    ...
    L["< 角色总览 >"] = true
    L["装等/等级"] = true
    L["团本CD显示为BOSS击杀数量"] = true
    L["没全通的副本，现在会显示击杀的BOSS数量，而不是显示一个绿色钩子。"] = true
    L["提醒：等团长拾取装备后再传送，否则表格无法记录此掉落"] = true
    L["提醒：等团长拾取装备后再出本，否则表格无法记录此掉落"] = true
    L["大秘境"] = true
    L["拍卖教程"] = true
    L["拍卖版本："] = true
    L["被过滤的装备自动折叠"] = true
    L["启用装备过滤时，如果拍卖的装备不合适你，自动折叠。"] = true
    L["需全团安装%s，没安装的人将会看不到拍卖窗口。"] = true
    L["自动拍卖版本"] = true
    L["禁用此功能"] = true
    L["已禁用自动移除屏蔽对象功能。"] = true
    L["由于你的部分角色同时存在于多个子战网，导致同步异常。输入该命令查看解决办法：|cffffffff/bgre"] = true
    L["勾选你的主属性，如果装备里不含该属性，则会被过滤"] = true
    L["主属性"] = true
    ...
    L["|cffDC143C< 退货失败 >|r\n表格里没找到此件装备"] = true
    L["|cffDC143C< 退货失败 >|r\n只能对1件装备进行退货处理"] = true
    L["|cffff0000错误：不要把该装备放在一起交易"] = true
    L["自动点击交易按钮"] = true
    L["简化活动列表"] = true
    L["删除活动列表的星团长标记、活动模式、进语音这些无用信息，使得活动说明的显示空间更大。"] = true
    L["QQ群"] = true
    L["不能设置为心愿，因为该装备未知由哪个物品兑换"] = true
    L["已向%s发送请求%s。"] = true
    L["（需要对方在副本外才能发送表格）"] = true
    L["|cffff0000由于服务器限流，在副本里无法发送表格，请你出本后再尝试。"] = true
    L["我买的"] = true
    L["已拍"] = true
    L["成功(未交易)"] = true
    ...
    L["缺少站位图数据，无法显示。"] = true
    L["显示团长上次发送的站位图。"] = true
    L["快捷命令：/bgmap 或 /aimap"] = true
    L["关闭拍卖记录"] = true
    L["显示拍卖记录"] = true
    L["小心偷家语音提醒"] = true
    L["没有使用自动出价时，如果拍卖剩余时间低于10秒时被顶价，语音提醒你\"小心偷家\"。"] = true
    L["按下 Ctrl+X 复制文本"] = true
    L["把链接发到聊天框"] = true
    L["把链接私发给团长"] = true
    L["备注"] = true
    L["备注："] = true
    L["需要登录该角色所在的账号才能修改备注。"] = true
    L["修改备注"] = true
    L["正在修改%s|r的备注"] = true
    L["文本使用职业颜色："] = true
    L["使用方法：/BGR，把角色总览面板固定，然后鼠标点击角色对应的备注栏即可修改备注。"] = true
    L["升级道具"] = true
    L["正义奖章"] = true
    L["请给团长个评价吧！"] = true
    L["交易中:"] = true
    L["交易后台提醒"] = true
    L["交易时，如果魔兽世界在后台运行，任务栏图标会闪烁提醒。"] = true
    L["鼠标提示装备的历史价格区间"] = true
    L["鼠标悬浮在一个装备时，显示其历史价格区间，数据来自你的历史表格。"] = true
    L["BGLite历史价格"] = true
    L["读取中"] = true
    L["%s-%s"] = true
    L["（占比%s%%）"] = true
    L["请求CD中..."] = true
    L["正在给%s发送表格，字符串长度%s。"] = true
    L["|cff00ff00已成功接收%s的表格。"] = true
    L["已有橙武"] = true
    L["|cffff0000（该链接为旧版本表格，已失效）"] = true
    L["自动弹出复制应付金额窗口"] = true
    L["交易时，无需点击按钮，复制应付金额的窗口会自动弹出。"] = true
    L["P1三本"] = true
    L["节日:"] = true
    L["情人节"] = true
    ...
    L["输入框字号"] = true
    L["BGLite插件大量使用输入框，该选项可以修改其字体大小。"] = true
    L["输入框字号（需重载）"] = true
    L["清空表格时的金币："] = true
    L["开启该模块需要重载游戏。\n现在立刻重载吗？"] = true
    L["+职业"] = true
    ...
    L["（合计%s）"] = true
    L["烹饪技能点"] = true
    L["按下 Ctrl+X 复制金额"] = true
    L["工资与补贴"] = true
    L["工资与补贴："] = true
    L["增加复制工资与补贴的按钮。"] = true
    L["复制应付金额"] = true
    L["在交易界面增加一个复制应付金额的按钮。"] = true
    L["复制"] = true
    L["罚款格子满了。。"] = true
    L["< 交易记账成功 >|r\n项目：|cffff0000罚款|r\n玩家：%s\n金额：%s%d|rg"] = true
    L["魔古山宝库"] = true
    L["v3.1：修复了输入框变绿的问题"] = true
    ...
    L["已完成橙片任务。"] = true
    L["未知橙片数量|cffFFD100（该玩家可能未安装BGLite插件，或者BGLite插件版本太低）|r"] = true
    L["|cff00ff00已完成任务|r"] = true
    L["|cffff0000未知数量|r"] = true
    L["|cffff0000(未知数量)|r"] = true
    L["|cffff0000未指定|r"] = true
    L["重置配置"] = true
    L["确认重置BGLite插件的所有配置文件？包括心愿清单、历史表格、角色总览、设置选项等等全部都会被重置。"] = true
    ...
    L["修改排序"] = true
    L["角色自定义排序"] = true
    L["如果你想删除这些角色，点击按钮后会在可删除角色后面显示一个删除按钮。"] = true
    L["商品总览"] = true
    L["装备过滤："] = true
    L["把商品按装备部位进行排列，并且可以自定义过滤。"] = true
    L["该功能仅对销售装备的商人生效。"] = true
    L["职业相关"] = true
    L["已拍未交易"] = true
    ...
    L["取消勾选则不会保存表格。"] = true
    L["不显示低于该装等的角色："] = true
    L["|cffFFFFFF安装WA：|r此WA是团员端，用于接收团长发出的拍卖消息，没安装的团员显示不了拍卖UI。请团长安装该WA字符串后发给团员安装。如果团员已经安装了BGLite插件，可以不用安装该WA。"] = true
    L["v2.5：拍卖金额超过1万时会进行缩写。ALT+点击折叠时，会对全部拍卖窗口折叠"] = true
    L["历史最大金币"] = true
    L["工程技能点"] = true
    L["获得小宠物数量"] = true
    L["<BGLite> 已自动清空表格< %s >，分钱人数已改为%s人。"] = true
    L["你的BGLite插件存在问题，请删除本地插件再重新安装一次（需要大退）。"] = true
    L["团员名单"] = true
    L["< 交易记账成功 >|r\n装备：%s\n买家：%s\n金额：%s%d|rg%s\nBoss：%s%s|r"] = true
    ...
    L["你可在插件设置-BGLite-其他功能-查询记录里关闭这个功能。"] = true
    L["关闭名单"] = true
    ...
    L["进入DD语音"] = true
    L["进入团长的DD语音房间"] = true
    L["需要你在后台已打开网易DD，否则进入失败。\n\n|cff808080你可在插件设置-BGLite-其他功能-密语模板里关闭这个功能。|r"] = true
    L["罚款"] = true
    L["点击记入杂项"] = true
    L["YY："] = true
    L["评价："] = true
    ...
    L["把对方账单的金额覆盖我当前表格的金额。如果对方是BGLite插件的账单，则也会复制其买家。"] = true
    ...
    L["已删除<%s>的举报记录。"] = true
    L["删除举报记录"] = true
    L["删除该名玩家在BGLite插件里的全部举报记录。\n\n|cff808080你可在插件设置-BGLite-其他功能里关闭这个功能。|r"] = true
    L["遭劫货物"] = true
    ...
    L["你可在插件设置-BGLite-其他功能里关闭这个功能。"] = true
    L["查询记录"] = true
    L["|cff00BFFF<BGLite>|r 已自动取消%s的|cff00BFFF关注|r和|cff00FF00心愿|r。"] = true
    L["|cff00BFFF<BGLite>|r 已自动取消%s的|cff00BFFF关注|r。"] = true
    L["|cff00BFFF<BGLite>|r 已自动取消%s的|cff00FF00心愿|r。"] = true
    L["全阶段"] = true
    L["小团本%s"] = true
    L["当前没有满级角色"] = true
    L["恶意骚扰"] = true
    ...
    L["该目标类型不是玩家。"] = true
    L["你没有目标。"] = true
    L["集结号增强|cff808080（该功能由BGLite插件提供）|r"] = true
    L["不自动退出集结号频道"] = true
    ...
    L["|cffFFFFFF安装WA：|r此WA是团员端，用于接收团长发出的拍卖消息，没安装的团员显示不了拍卖UI。请团长安装该WA字符串后发给团员安装。如果团员已经安装了BGLite插件并且版本在1.7.0或以上，可以不用安装该WA。"] = true
    ...
    L["<BGLite> 已自动清空表格< %s >，分钱人数已改为%s人。原表格数据已保存至历史表格1。"] = true
    L["撤回清空"] = true
    L["<BGLite> 已撤回清空，还原了表格数据，并删除了历史表格1。"] = true
    L["只能撤回一次。"] = true
    L["没有欠款"] = true
    L["当前装备自动记录位置："] = true
    L["BOSS战开始"] = true
    ...
    L["对账"] = true
    L["< 对账 >"] = true
    L["当团队有人通报BGLite/RaidLedger/大脚的账单，你可以选择该账单，来对账"] = true
    ...
    L["含有%s属性的装备"] = true
    L["如果你想关闭该功能，可在插件设置-BGLite-角色总览里关闭"] = true
    L["SHIFT+点击："] = true
    L["< 我是教程 >"] = true
    ...
    L["< 查询大众评价 >"] = true
    L["1、对BGLiteYY频道的在线玩家发出该YY的请求"] = true
    ...
    L["远程职责"] = true
    L["该副本没有团本攻略"] = true
    L["< BGLite > 你的当前版本%s已过期，请更新插件。"] = true
    ...
    L["<UI缩放>"] = true
    L["<UI透明度>"] = true
    L["< BGLite > 版本过期提醒，最新版本是：%s，你的当前版本是：%s"] = true
    L["星星"] = true
    L["BGLite金团表格"] = true
    L["显示/关闭表格"] = true
    L["对比的账单："] = true
...
do -- 邮件记录
    ...
    L["发送物品："] = true
    L["付款取信："] = true
    L["该角色没有该类型的邮件记录。"] = true
    L["合并相邻的拍卖行邮件"] = true
    L["类型"] = true
    L["没有附件的邮件，也会被显示。"] = true
    L["内容："] = true
    L["确认删除%s的邮件记录？"] = true
    L["收到金额："] = true
    L["收到物品："] = true
    ...
    L["显示空邮件"] = true
    L["显示拍卖行邮件"] = true
    L["相邻的拍卖行邮件会被合并显示为一个邮件，节省空间。"] = true
    L["已删除%s的邮件记录。"] = true
    L["邮寄后财产"] = true
    L["邮寄前财产"] = true
    L["邮件对象"] = true
...
do
    ...
    L["拍卖时长："] = true
    L["显示阵营"] = true
    L["角色总览中的角色装等和等级会根据阵营染色为浅蓝色（联盟）或浅红色（部落），用来区分该角色是哪个阵营。"] = true
    L['正在第1章'] = true
    L['已完成第1章'] = true
    L['已完成第2章'] = true
    L['已完成第3章'] = true
    ...
    L["未知(离线)"] = true
    L["显示角色专精"] = true
    L["在角色名字前面增加显示专精图标。"] = true
    L["显示角色阵营"] = true
    L["角色装等和等级会根据阵营染色为浅蓝色（联盟）或浅红色（部落），用来区分该角色是哪个阵营。"] = true
    L['不在团队里。'] = true
    L['表格没有历史成员名单。'] = true
    L['表格的历史成员名单的创建时间已超过1天，判断为现在是新团队。'] = true
    L['表格的历史成员名单服务器是[%s]，与当前服务器[%s]不同，判断为现在是新团队。'] = true
    L['表格的历史成员人数为%s，当前团队人数为%s，相同成员的占比低于60%%，判断为现在是新团队。'] = true
    L['当前副本所在的表格BOSS编号（%s-%s）格子中存在旧记录。'] = true
    L['自动清空表格的原因：1.当前副本你是新CD；2.%s'] = true
    L["已撤回清空，还原了表格数据，并删除了历史表格1。"] = true
    L['|cffFFD100物品等级'] = true
    L['已自动把分配品质切换至|c%s%s|r。'] = true
    L['|cff808080兑换后的装备|r\n'] = true
    L['|cffFFD100物品等级%s|r\n'] = true
    L["记账成功！"] = true
    L["记账失败！表格里没有匹配到合适的装备！"] = true
    L["你以|cffffff00%s金|r成功竞拍%s，需要记账进表格吗？"] = true
    L["|cffffff00十字军宝珠"] = true
    L["祖格周常"] = true
    L["部分Boss自动切换分配品质"] = true
    L["比如进入祖格的疯狂之缘时，自动把分配品质切换为绿色。"] = true
    L["Alt+点击才能生效"] = true
    L["只有团长或物品分配者有权限取消拍卖"] = true
    L["根据你的出价动态改变增减幅度"] = true
    L["长按可以快速调整价格"] = true
    L["在输入框使用滚轮也可快速调整价格"] = true
    L[">> 你 <<"] = true
    L["你"] = true
    L["需高于当前价格"] = true
    L["需高于或等于起拍价"] = true
    L["取消拍卖"] = true
    L["|cffFFD100当前价格：|r"] = true
    L["|cffFFD100起拍价：|r"] = true
    L["|cffFFD100出价最高者：|r"] = true
    L["出价"] = true
    L["拍卖结束"] = true
    L["|cffFF0000流拍：|r"] = true
    L["|cff00FF00成交价：|r"] = true
    L["|cff00FF00买家：|r"] = true
    L["{rt6}拍卖成功{rt6} %s %s %s"] = true
    L["{rt7}拍卖取消{rt7} %s"] = true
    L["{rt7}流拍{rt7} %s"] = true
    L["拍卖取消"] = true
    L["滚轮：快速调整价格"] = true
    L["长按：快速调整价格"] = true
    ...
    L["心理价格锁定中"] = true
    L["取消自动出价后才能修改。"] = true
    L["如果别人出价比你高时，自动帮你出价，每次加价为最低幅度，出价不会高于你设定的心理价格。"] = true
    L["心理价格"] = true
    L["最小加价幅度为%s"] = true
    L["没有人出价"] = true
    L["出价设为："] = true
    ...
    L["点击：单个折叠"] = true
    L["ALT+点击：全部折叠"] = true
    L["你已是%s的出价最高者，|cffff0000没必要自己顶自己|r。真的要继续出价到 %s ？"] = true
    L["{rt1}拍卖开始{rt1} %s 起拍价：%s"] = true
    L["|cffff0000该装备在拍卖结束后一直没收到团长发出的团队通知，所以你显示的拍卖结果可能不正确，请告知团长。"] = true
    L["|cffff0000团长离线，该装备的拍卖结果可能不正确。"] = true
    L["心理价格需高于或等于起拍价"] = true
    L["心理价格需高于当前价格"] = true
    L["|cffFF0000流拍"] = true
    L["左键：单个展开"] = true
    L["右键：全部展开"] = true
    ...
    L["右键：全部折叠"] = true
    L['剩余%s秒时出价'] = true
    L['%s、%s（%s）|cffff0000%s'] = true
    L["%s的剩余时间不到%s秒时我出价%s。卡秒出价可能导致拍卖出错！"] = true
    L["更多操作"] = true
    L["恢复拍卖"] = true
    L["暂停拍卖"] = true
    L["重置阈值(秒)"] = true
    L["当剩余时间低于此阈值时有人出价，拍卖时间会自动重置回该阈值。"] = true
    L["阈值不能低于10秒。"] = true
    L["仅第二代拍卖可以修改。"] = true
    L["|cffFFD100拍卖版本|r"] = true
    L["第一代拍卖"] = true
    L["第二代拍卖"] = true
    L["已暂停"] = true
    L['需要团员的BGLite版本高于v2.0.0，否则团员无法看见拍卖框。'] = true
    L["正在核对"] = true
    L["忽略战网绑定"] = true
    L["忽略战网绑定的装备"] = true
    L["勾选后，战网绑定物品即使被其他过滤规则命中，也不会被隐藏"] = true
    L["使用黑白着色"] = true
    L["勾选后每行使用黑白着色。否则使用下横线作分割。该选项仅对横向布局有效。"] = true
    L["升级物品"] = true
    L["锁定拍卖竞价窗口"] = true
    L["拍卖竞价窗口默认不可拖动，需要按住SHIFT键才能拖动。"] = true
    L["|cffff0000警告：疑似你正在把欠款和装备同时交易，这会导致账单错误！|r\n\n本次交易你应让对方仅结清欠款|cffffff00%s金|r（不要摆放装备），完成后再发起新的交易给对方装备！"] = true
    L["知道了"] = true
    L["已向团长发送重拍申请："] = true
    L["已提醒团长拍卖："] = true
    L["申请太频繁了，等待3秒后再尝试。"] = true
    L['%s 向你申请重拍流拍装备：\n\n%s%s（流拍价：%s）\n\n是否重拍该装备？'] = true
    L['%s 提醒你拍卖未拍装备：\n\n%s%s\n\n是否打开拍卖界面？'] = true
    L['%s 提醒你拍卖未拍装备：\n\n%s%s'] = true
    L['向团长申请重拍'] = true
    L['提醒团长拍卖'] = true
    L['团长的BGLite版本高于v2.0.7时才能收到你的请求。'] = true
    L["%s向你申请重拍流拍装备：%s（%s金）。"] = true
    L["%s提醒你拍卖未拍装备：%s。"] = true
    L["常规模式"] = true
    L['错误：同时拍卖的数量不能超过%s个'] = true
    ...
    L["自动"] = true
    L['|cff808080可换成此装备|r\n'] = true
    L['未关注且未加入心愿单的装备自动折叠'] = true
    L["仅保留关注/心愿装备展开，其余自动折叠。"] = true
    L['%s的拍卖记录已被改为未拍。'] = true
    L['%s的拍卖记录已被改为流拍。'] = true
    L['%s的拍卖记录已被改为正在拍卖。'] = true
    L["|cffFFD100拍卖数量|r"] = true
    L["重新拍卖%s吗？\n\n起拍价：%s"] = true
    L['团长已退货：\n\n%s%s\n买家：%s\n金额：%s\n\n是否把该条拍卖记录设为流拍？'] = true
    L['%s%s 广播退货消息：\n\n%s%s\n买家：%s\n退货金额：%s\n\n把该条拍卖记录设为流拍吗？'] = true
    L["一键重拍"] = true
    L["未拍和流拍页可以按住CTRL、SHIFT，或者框选来多选装备，便于团长批量发起拍卖"] = true
    L["忽略炼金转化（需重载）"] = true
    L["忽略制皮筛盐（需重载）"] = true
    L["忽略裁缝洗布（需重载）"] = true
    L["忽略炼金研究（需重载）"] = true
    ...
    L["忽略帝王丝绸（需重载）"] = true
    L["已开始自动出价：%s %s。"] = true
    L['团长的BGLite版本高于%s时才能收到你的请求。'] = true
    L["拍重"] = true
    L["以下装备可能存在重复拍卖："] = true
end
...
do
    ...
    L["历史表格正在汇总！"] = true
    L["历史最高价：%s"] = true
    L["没有数据，请尝试重新汇总。\n如果还是没有，说明你的历史表格里没有合适的数据。"] = true
    L["你不在团队中。"] = true
    L["你没有公会。"] = true
    L["你没有目标，或者目标不是一名玩家。"] = true
    L["频道："] = true
    L["枪械"] = true
    L["全部展开"] = true
    L["全部折叠"] = true
    L["缺少有效的历史表格数据！"] = true
    L["鼠标悬停在玩家时，显示其历史总消费金额和跟团次数"] = true
    L["数据汇总完成！"] = true
    L["搜索玩家或职业"] = true
    L["搜索装备或类型"] = true
    L["——通报历史消费记录——"] = true
    ...
    L["总消费:"] = true
    L["最高价"] = true
    L["总消费：|cffffffff"] = true
    L["跟团次数：|cffffffff"] = true

    -- 团长历史喊话
    L["|cff808080%s|r |cff%s%s|r"] = true
    L["|cff808080%s|r |cff%s[%s]%s：%s|r"] = true
    L["查看团长在公共频道和集结号最近5小时的喊话内容，便于团员核对账单的补贴是否跟喊话一致"] = true
    L["导出聊天记录"] = true
    L["喊话记录"] = true
    L["历史喊话"] = true
    L["没有喊话记录。"] = true
    ...
    -- L[] = true
    -- L[] = true
    -- Lite: 恢复交易/邮件模块补回的本地化 key（2026-08-24 按 BiaoGe v2.3.5）
    L["(收件人名字)"] = true
    L["{C}，这是你的工资，请查收。\n感谢你参与本次金团活动！^_^\n\n邮件发送时间：{E}"] = true
    L["|cffff0000批量邮寄被终止。|r\n邮寄人数：%s，已邮寄：%s，未邮寄：%s。"] = true
    L["|cffff0000身上金币不够，批量邮寄已停止。|r\n邮寄人数：%s，已邮寄：%s，未邮寄：%s。"] = true
    L["不能给自己邮寄！"] = true
    L["主题不能为空。"] = true
    L["你可以在主题和内容里使用变量，系统会把特定字符自动变为对应的数字或文本。"] = true
    L["你当前没有团队。"] = true
    L["使用|cffffffff%s|r作为多个名字的分隔符。"] = true
    L["删除该玩家"] = true
    L["刷新团队框架"] = true
    L["发件人名字"] = true
    L["变量"] = true
    L["合计邮寄金额%s %s，你的钱不够。"] = true
    L["合计金额：%s %s"] = true
    L["名单："] = true
    L["名字一共|cff00ff00%s|r个"] = true
    L["回车"] = true
    L["实际发送效果："] = true
    L["实际效果:"] = true
    L["导入名单"] = true
    ...
    L["开始批量邮寄"] = true
    L["批量邮寄工资"] = true
    L["批量邮寄已完成。\n邮寄人数：%s，成功：%s，失败：%s。"] = true
    L["收件人名字"] = true
    L["日期和时间"] = true
    L["服务器限制同一账号1小时内最多只能邮寄20人。你可以用当前账号邮寄20人，双开用另一个账号邮寄剩下的人。"] = true
    L["服务器限制短时间内最多只能给20名不同玩家发送邮件。你当前选择的人数已经超过20人，可能会导致部分玩家邮寄失败。"] = true
    L["正在批量邮寄：%s/%s"] = true
    L["特定字符:"] = true
    L["确定开始批量邮寄？"] = true
    L["确定禁用批量邮寄功能？\n需要重载游戏才能生效。"] = true
    ...
    -- Lite: 其他功能页补回的本地化 key（2026-08-24）
    L["启用批量邮寄工资"] = true
    ...
    L["装备偏好"] = true
    L["< 装备偏好 >"] = true
    L["设置当前角色的职责、属性偏向和命中门槛，表格与拍卖按此给你算升级分。"] = true
    L["设置当前角色的职责、属性价值和命中门槛，表格与拍卖按此给你算升级分。"] = true
    L["按职业和当前天赋自动判断职责，无需选择近战、远程或法系。可在此切换天赋，表格与拍卖按此给你算升级分。"] = true
    L["按职业和当前天赋自动判断职责。分数对比你当前的装备，用来判断性价比，不是全团同一张BIS。"] = true
    L["分数只针对你自己，对比的是你当前穿的装备。缺命中时命中装分高，达标后别人会去抢别的属性。这是性价比，不是全团同一张BIS。"] = true
    L["分数只针对你自己，对比的是你当前穿的装备。白字只是一部分，绿字（命中/暴击/急速/破甲/攻强/法强）经常更值钱。缺命中时命中装分高，达标后别人会去抢别的属性。"] = true
    L["默认按天赋给出属性价值，用来判断这件对你值不值得加价。可按自己的配装习惯改，改完之后你的升级分就会跟别人不一样。"] = true
    L["默认按天赋给出属性价值，绿字（命中/暴击/急速/破甲/攻强/法强）按模拟器权重计，往往比白字更值钱。可按自己的配装习惯改。"] = true
    L["白字"] = true
    L["绿字"] = true
    L["装备评分"] = true
    L["启用自身装备评分"] = true
    ...
    L["在拍卖竞价窗显示升级分"] = true
    L["团长开拍时，竞价窗物品名下显示你的推荐升级分。"] = true
    L["团长开拍时，竞价窗物品名右侧显示你的推荐升级分。"] = true
    L["团长开拍时，竞价窗物品名称后面显示你的推荐升级分。"] = true
    L["自身状态"] = true
    L["装等"] = true
    L["达标"] = true
    L["未达标"] = true
    ...
    L["法系"] = true
    L["主坦"] = true
    L["勾选后把防御当作硬门槛。副坦可以取消。"] = true
    L["双持命中帽"] = true
    L["近战双持把命中门槛从 8% 改为 27%。"] = true
    L["法术命中按17%"] = true
    L["不勾选时按 14%（团队命中减益）。天赋和种族提供的命中会自动计入。"] = true
    L["天赋"] = true
    L["种族"] = true
    L["偏向"] = true
    L["主偏向"] = true
    ...
    L["属性价值"] = true
    L["自定义属性价值"] = true
    L["根据您的需求在输入框中输入对应项目的自定义属性价值。"] = true
    L["默认"] = true
    L["自定义"] = true
    L["重置所有为默认"] = true
