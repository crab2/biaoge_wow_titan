...
do
    ...
    L["|cff0070dd宝石"] = "|cff0070ddGem"
    L['< 按住CTRL+SHIFT隐藏此界面 >'] = "< Hold CTRL+SHIFT to hide this interface >"
    L["BGLite插件提醒：由于暴雪对插件UI数量的限制，本插件无法在硬核服务器使用，请你自行禁用。"] = "BGLite Addon Reminder: Due to Blizzard's UI limit for addons, this addon cannot be used on Hardcore servers. Please disable it manually."
    L["显示悬浮框"] = "Show Floating Frame"
    L["悬浮框缩放"] = "Floating Frame Scale"
    L["调整悬浮框UI的大小。"] = "Adjust floating frame UI size."
    L["悬浮框层级"] = "Floating Frame Layer"
    L["|cff808080流拍价："] = "|cff808080Unsold Price:"
    L["也有可能是你的WCL插件缺少本服务器数据包。鼠标指向一个玩家时，如果不显示WCL数据，说明就是上述问题。此问题与BGLite插件无关。"] = "It may also be that your WCL addon lacks data files for this server. If no WCL data shows when hovering over players, that is the cause. This issue has nothing to do with BGLite."
    L["保存"] = "Save"
    L["分享"] = "Share"
    L["导出"] = "Export"
    L["应用"] = "Apply"
    L["返回"] = "Back"
    L['ID:%s 剩余%s'] = "ID:%s Remaining:%s"
    L['用户信息'] = "User Info"
    L['用户ID：%s'] = "User ID: %s"
    L['用户名：%s'] = "Username: %s"
    L['天'] = "Days"
    L['流拍装备卖店总价：%s金'] = "Total vendor value of unsold items: %s Gold"
    L["搜索装备/买家/金额"] = "Search Item / Buyer / Amount"
    L["|cffff0000（插件被你禁用了）"] = "|cffff0000(Addon is disabled)"
    L["禁止NDui插件交易时自动打开背包"] = "Prevent NDui from auto-opening bags during trade"
    L["对方欠款记录："] = "Counterparty Debt Record:"
    L["重复交易工资提醒："] = "Duplicate Wage Trade Alert:"
    L["交易金额超上限提醒："] = "Trade Amount Over Limit Alert:"
    L["交易后台提醒："] = "Trade Background Alert:"
    L["在交易界面增加以下功能"] = "Add the following features to trade window"
    L["小队工资"] = "Party Wage"
    L["横向布局1"] = "Horizontal Layout 1"
    L["横向布局2"] = "Horizontal Layout 2"
    L["竖向布局"] = "Vertical Layout"
    L["< 角色总览 >"] = "< Character Overview >"
    L["装等/等级"] = "Item Level / Level"
    L["团本CD显示为BOSS击杀数量"] = "Raid ID displays defeated boss count"
    L["没全通的副本，现在会显示击杀的BOSS数量，而不是显示一个绿色钩子。"] = "For incomplete raids, defeated boss count will be shown instead of a green checkmark."
    L["提醒：等团长拾取装备后再传送，否则表格无法记录此掉落"] = "Reminder: Wait until the raid leader loots items before teleporting, otherwise the loot will not be recorded in the table."
    L["提醒：等团长拾取装备后再出本，否则表格无法记录此掉落"] = "Reminder: Wait until the raid leader loots items before leaving the instance, otherwise the loot will not be recorded in the table."
    L["大秘境"] = "Mythic Dungeon"
    L["拍卖教程"] = "Auction Guide"
    L["拍卖版本："] = "Auction Version:"
    L["被过滤的装备自动折叠"] = "Auto-Collapse Filtered Items"
    L["启用装备过滤时，如果拍卖的装备不合适你，自动折叠。"] = "When item filtering is enabled, unsuitable auction items will be collapsed automatically."
    L["需全团安装%s，没安装的人将会看不到拍卖窗口。"] = "Requires all raid members to install %s. Players without the addon cannot see the auction window."
    ...
    L["物理命中"] = "Physical Hit"
    L["你击中目标"] = "Your Hits"
    L["物理爆击"] = "Physical Critical"
    L["你造成爆击"] = "Your Critical Strikes"
    L["法系命中"] = "Spell Hit"
    L["你的法术击中"] = "Your Spell Hits"
    L["法系爆击"] = "Spell Critical"
    L["你的法术造成爆击"] = "Your Spell Criticals"
    L["特定法术强度"] = "Specific Spell Power"
    L["法术和效果所造成的伤害"] = "Damage dealt by spells and effects"
    L["仅加法强，不加奶强，治疗需要过滤此词缀"] = "Only increases spell damage, no healing power. Healers please filter."
    L["法术强度"] = "Spell Power"
    L["所有法术和魔法效果所造成的伤害和治疗效果"] = "All spell damage and healing effects"
    L["法强+奶强"] = "Spell Damage + Healing Power"
    L["治疗强度"] = "Healing Power"
    L["法术所造成的治疗效果"] = "Healing from spells"
    L["法术治疗提高"] = "Increased Spell Healing"
    L["法术和效果造成的治疗提高"] = "Increased healing from spells and effects"
    L["死亡骑士"] = "Death Knight"
    L["死亡骑士-鲜血"] = "Death Knight - Blood"
    L["死亡骑士-冰霜"] = "Death Knight - Frost"
    L["死亡骑士-邪恶"] = "Death Knight - Unholy"
    L["战士"] = "Warrior"
    L["战士-防御"] = "Warrior - Protection"
    L["战士-武器"] = "Warrior - Arms"
    L["战士-狂怒"] = "Warrior - Fury"
    L["圣骑士"] = "Paladin"
    L["圣骑士-防御"] = "Paladin - Protection"
    L["圣骑士-惩戒"] = "Paladin - Retribution"
    L["圣骑士-神圣"] = "Paladin - Holy"
    L["猎人"] = "Hunter"
    L["猎人-兽王"] = "Hunter - Beast Mastery"
    L["猎人-射击"] = "Hunter - Marksmanship"
    L["猎人-生存"] = "Hunter - Survival"
    L["萨满"] = "Shaman"
    L["萨满-增强"] = "Shaman - Enhancement"
    L["萨满-元素"] = "Shaman - Elemental"
    L["萨满-恢复"] = "Shaman - Restoration"
    L["唤魔师"] = "Evoker"
    L["德鲁伊"] = "Druid"
    L["德鲁伊-巨熊"] = "Druid - Guardian"
    L["德鲁伊-猎豹"] = "Druid - Feral"
    L["德鲁伊-平衡"] = "Druid - Balance"
    L["德鲁伊-恢复"] = "Druid - Restoration"
    L["盗贼"] = "Rogue"
    L["武僧"] = "Monk"
    L["武僧-酒仙"] = "Monk - Brewmaster"
    L["武僧-踏风"] = "Monk - Windwalker"
    L["武僧-织雾"] = "Monk - Mistweaver"
    L["恶魔猎手"] = "Demon Hunter"
    L["恶魔猎手-复仇"] = "Demon Hunter - Vengeance"
    L["恶魔猎手-浩劫"] = "Demon Hunter - Havoc"
    L["恶魔猎手-噬灭"] = "Demon Hunter - Ruin"
    L["牧师"] = "Priest"
    L["牧师-暗影"] = "Priest - Shadow"
    L["牧师-戒律"] = "Priest - Discipline"
    L["牧师-神圣"] = "Priest - Holy"
    L["法师"] = "Mage"
    L["术士"] = "Warlock"
    ...
    L["正在修改%s|r的备注"] = "Editing notes for %s|r"
    ...
    L["BGLite历史价格"] = "BGLite Historical Price"
    L["读取中"] = "Loading"
    L["%s-%s"] = "%s-%s"
    L["（占比%s%%）"] = "(Percentage: %s%%)"
    ...
    L["BGLite插件大量使用输入框，该选项可以修改其字体大小。"] = "The BGLite AddOn uses numerous input boxes; this option allows you to modify their font size."
    ...
    L["角色总览背景透明度"] = "Character Overview Background Opacity"
    L["调整角色总览背景的透明度。"] = "Adjust the opacity of the Character Overview background."
    ...
    L["未知橙片数量|cffFFD100（该玩家可能未安装BGLite插件，或者BGLite插件版本太低）|r"] = "Unknown number of orange slices |cffFFD100 (this player may not have the BGLite plugin installed, or the BGLite plugin version is too low) |r"
    ...
    L["确认重置BGLite插件的所有配置文件？包括心愿清单、历史表格、角色总览、设置选项等等全部都会被重置。"] = "Confirmed to reset all configuration files of BGLite plugin? This includes Wish Lists, History Tables, Character Overview, Settings Options, etc. All will be reset."
    ...
    L["需要你是团长时才会生效。"] = "Requires that you are the team leader for this to work."
    ...
    L["BGLite正在申请确认交易"] = "BGLite is requesting a trade confirmation"
    ...
    L["<BGLite> 已自动清空表格< %s >，分钱人数已改为%s人。"] = "<BGLite> has automatically cleared the table < %s > and the number of people splitting money has been changed to %s of people."
    L["你的BGLite插件存在问题，请删除本地插件再重新安装一次（需要大退）。"] = "There is a problem with your BGLite plugin, please delete the local plugin and reinstall it again (requires a major regression)."
    ...
    L["交流群"] = "QQGroup"
    L["BGLite插件未来的更新计划共享在在线文档。"] = "BGLite plugin's future update plan is shared in an online document."
    ...
    L["你可在插件设置-BGLite-其他功能-查询记录里关闭这个功能。"] = "You can rf this function in Plugin Settings - BGLite - Other Functions - Query Records."
    L["关闭名单"] = "rf list"
    ...
    L["你可以在这里更新BGLite插件。"] = "You can update BGLite plugins here."
    ...
    L["需要你在后台已打开网易DD，否则进入失败。\n\n|cff808080你可在插件設置-BGLite-其他功能-密語模板裡關閉這個功能。|r"] = "Requires you to have opened Netflix DD in the background, otherwise entry fails. \n\n|cff808080You can turn off this function in Plugin Settings-BGLite-Other Functions-Secret Message Template. |r"
    L["罚款"] = "Fine"
    ...
    L["把对方账单的金额覆盖我当前表格的金额。如果对方是BGLite插件的账单，则也会复制其买家。"] = "Overwrite the amount of the other party's bill with the amount of my current form. If the other party is billed by the BGLite plugin, it will also copy its buyer."
    ...
    L["删除该名玩家在BGLite插件里的全部举报记录。\n\n|cff808080你可在插件设置-BGLite-其他功能里关闭这个功能。|r"] = "Delete all report records of this player in BGLite plugin. \n\n|cff808080 You can rf this function in Plugin Settings - BGLite - Other Functions. |r"
    L["遭劫货物"] = "Looted Goods"
    ...
    L["你可在插件设置-BGLite-其他功能里关闭这个功能。"] = "You can rf this function in Plugin Settings - BGLite - Other Functions."
    L["查询记录"] = "Query Records"
    L["|cff00BFFF<BGLite>|r 已自动取消%s的|cff00BFFF关注|r和|cff00FF00心愿|r。"] = "|cff00BFFF<BGLite>|r has automatically canceled %s of |cff00BFFF Follows|r and |cff00FF00 Wishes|r."
    L["|cff00BFFF<BGLite>|r 已自动取消%s的|cff00BFFF关注|r。"] = "|cff00BFFF<BGLite>|r has automatically canceled %s of |cff00BFFF concerns|r."
    L["|cff00BFFF<BGLite>|r 已自动取消%s的|cff00FF00心愿|r。"] = "|cff00BFFF<BGLite>|r has automatically canceled %s of |cff00FF00 Wish|r."
    L["全阶段"] = "Full Stage"
    ...
    L["选择举报理由：%s\n选择举报项目：%s\n填写举报细节：%s\n\n快捷命令：/BGReport\n\n|cff808080你可在插件设置-BGLite-其他功能里关闭这个功能。|r"] = "Choose the reason for reporting: %s\nSelect the item to report: %s\nFill in the details of the report: %s\n\nShortcut to 'Enchant Bracer - Superior Strength' : /BGReport\n\n|cff80808080You can rf this function in Plugin Settings - BGLite - Other Functions. |r"
    L["一键举报RMT"] = "One Click Report RMT"
    L["选择举报理由：%s\n选择举报项目：%s\n填写举报细节：%s\n\n|cff808080你可在插件设置-BGLite-其他功能里关闭这个功能。|r"] = "Select Report Reason: %s\nSelect Report Item: %s\nFill in Report Details: %s\n\n|cff80808080You can rf this function in Plugin Settings-BGLite-Other Functions. |r"
    ...
    L["集结号增强|cff808080（该功能由BGLite插件提供）|r"] = "Rally Enhancement|cff808080 (This feature is powered by BGLite plugin)|r"
    ...
    L["|cffFFFFFF安装WA：|r此WA是团员端，用于接收团长发出的拍卖消息，没安装的团员显示不了拍卖UI。请团长安装该WA字符串后发给团员安装。如果团员已经安装了BGLite插件并且版本在1.7.0或以上，可以不用安装该WA。"] = "|cffFFFFFFInstalled WA:|rThis WA is the member's side, it is used to receive the auction message from the leader, the members who don't have it installed won't be able to show the auction UI. please ask the leader to install this WA string and send it to the members to install. If you have installed BGLite plugin and version is 1.7.0 or above, you don't need to install this WA."
    ...
    L["你可在插件设置-BGLite-其他功能里关闭这个功能"] = "You can rf this function in the plugin settings - BGLite - Other Functions."
    ...
    L["对账"] = "Reconciliation"
    L["< 对账 >"] = "< Reconciliation >"
    L["当团队有人通报BGLite/RaidLedger/大脚的账单，你可以选择该账单，来对账"] = "When someone on your team reports a BGLite/RaidLedger/Bigfoot bill, you can select that bill to reconcile it."
    ...
    L["如果你想关闭该功能，可在插件设置-BGLite-角色总览里关闭"] = "If you want to rf this feature, you can rf it in the plugin settings - BGLite - Character Overview."
    ...
    L["1、对BGLiteYY频道的在线玩家发出该YY的请求"] = "1、Send a request for this YY to the online players of BGLiteYY channel"
    ...
    L["< BGLite > 你的当前版本%s已过期，请更新插件。"] = "< BGLite > Your current version of %s has expired, please update the plugin."
    ...
    L["< BGLite > 金 团 表 格"] = "< BGLite > Gold Group Forms"
    ...
    L["<UI缩放>"] = "<UI Zoom"
    L["<UI透明度>"] = "< UI Transparency"
    L["< BGLite > 版本过期提醒，最新版本是：%s，你的当前版本是：%s"] = "< BGLite > version expiration reminder, the latest version is: %s, your current version is: %s"
    L["星星"] = "Stars"
    L["BGLite金团表格"] = "BGLite Gold Corps Forms"
    ...
    L["—感谢使用金团表格—"] = "-Thanks for using Gold Raid Ledger-"
    L["队伍"] = "Team"
    L["公会"] = "Guild"
    L["团队"] = "Raid"
...
do
    ...
    L["|cffFF0000流拍"] = L["|cffFF0000Failed"]
    L["左键：单个展开"] = "Left Click: Expand Single"
    ...
    L["更多操作"] = "More"
    L["恢复拍卖"] = "Resume Auction"
    L["暂停拍卖"] = "Pause Auction"
    L["重置阈值(秒)"] = "Reset Threshold (Seconds)"
    L["当剩余时间低于此阈值时有人出价，拍卖时间会自动重置回该阈值。"] = "Bids placed below this threshold will reset auction time to this value."
    L["阈值不能低于10秒。"] = "Threshold cannot be less than 10 seconds."
    L["仅第二代拍卖可以修改。"] = "Only available for second-generation auction."
    L["|cffFFD100拍卖版本|r"] = "|cffFFD100Auction Version|r"
    L["第一代拍卖"] = "First-Gen Auction"
    L["第二代拍卖"] = "Second-Gen Auction"
    L["已暂停"] = "Paused"
    L['需要团员的BGLite版本高于v2.0.0，否则团员无法看见拍卖框。'] = "All raid members must run BGLite v2.0.0 or newer to view the auction frame."
    L["正在核对"] = "Verifying..."
    ...
    L['团长的BGLite版本高于v2.0.7时才能收到你的请求。'] = "The raid leader needs BGLite v2.0.7+ to receive your request."
    L['团长的BGLite版本高于%s时才能收到你的请求。'] = "The raid leader needs BGLite %s+ to receive your request."
    ...
    L['牧师人偶'] = "Priest Effigy"
    L['法师人偶'] = "Mage Effigy"
    L['术士人偶'] = "Warlock Effigy"
    L['盗贼人偶'] = "Rogue Effigy"
    L['德鲁伊人偶'] = "Druid Effigy"
    L['猎人人偶'] = "Hunter Effigy"
    L['萨满人偶'] = "Shaman Effigy"
    L['圣骑士人偶'] = "Paladin Effigy"
    L['战士人偶'] = "Warrior Effigy"
    L['死亡骑士人偶'] = "Death Knight Effigy"
    L["日常"] = "Daily"
    L["专业技能CD"] = "Profession Cooldowns"
    L["拍卖模式："] = "Auction Mode:"
    L["拍卖版本："] = "Auction Version:"
    L["拍卖时长："] = "Auction Duration:"
    L["重置阈值："] = "Reset Threshold:"
    L["起拍价："] = "Starting Bid:"
    L["恢复"] = "Resume"
    L["暂停"] = "Pause"
    L["自动"] = "Auto"
    L['|cff808080可换成此装备|r\n'] = "|cff808080Can exchange for this item|r\n"
    ...
    L["忽略制皮筛盐（需重载）"] = "Ignore Leatherworking Salt Refining (Requires Reload)"
    L["忽略裁缝洗布（需重载）"] = "Ignore Tailoring Cloth Washing (Requires Reload)"
    L["忽略炼金研究（需重载）"] = "Ignore Alchemy Research (Requires Reload)"
    L["忽略大雕文（需重载）"] = "Ignore Major Glyphs (Requires Reload)"
    L["忽略小雕文（需重载）"] = "Ignore Minor Glyphs (Requires Reload)"
    L["忽略冰冻棱柱（需重载）"] = "Ignore Frozen Prism (Requires Reload)"
    L["忽略泰坦精钢（需重载）"] = "Ignore Titansteel Smelting (Requires Reload)"
    L["忽略冰川背包（需重载）"] = "Ignore Glacier Bag Craft (Requires Reload)"
    L["忽略邪煞水晶（需重载）"] = "Ignore Sha Crystal Prospecting (Requires Reload)"
    L["忽略智慧卷轴（需重载）"] = "Ignore Scroll of Wisdom Research (Requires Reload)"
    L["忽略珠宝研究（需重载）"] = "Ignore Jewelcrafting Research (Requires Reload)"
    L["忽略神龙之心（需重载）"] = "Ignore Heart of the Dragon Craft (Requires Reload)"
...
do
    ...
    do
        ...
        L["伊墨苏斯"] = "Immerseus"
        L["堕落的守护者"] = "The Fallen Protectors"
        L["诺鲁什"] = "Norushen"
        L["傲之煞"] = "Sha of Pride"
        L["迦拉卡斯"] = "Galakras"
        L["钢铁战蝎"] = "Iron Juggernaut"
        L["库卡隆黑暗萨满"] = "Korkron Dark Shaman"
        L["纳兹戈林将军"] = "General Nazgrim"
        L["马尔考罗克"] = "Malkorok"
        L["潘达利亚战利品"] = "Spoils of Pandaria"
        L["嗜血的索克"] = "Thok the Bloodthirsty"
        L["攻城匠师黑索"] = "Siegecrafter Blackfuse"
        L["卡拉克西英杰"] = "Paragons of the Klaxxi"
        L["地狱咆哮"] = "Garrosh Hellscream"
        L["野牛人"] = "Yaungol"
        L["四天神"] = "August Celestials"
    end
...
do -- Trade history
    L["交易记录"] = "Trade History"
    L["交易成功时语音提醒"] = "Play a sound when a trade succeeds"
    L["交易失败时语音提醒"] = "Play a sound when a trade fails"
    L["交易通报"] = "Trade announcements"
    L["交易后把结果通报至指定频道。"] = "Announce the result to the selected channel after a trade."
    L["通报至："] = "Announce to: "
    L["交易成功时通报"] = "Announce successful trades"
    L["交易失败时通报"] = "Announce failed trades"
    L["(交出)"] = "(Given) "
    L["(收到)"] = "(Received) "
    L["保存时长："] = "Keep for:"
    L["地点"] = "Location"
    L["该角色没有交易记录。"] = "This character has no trade history."
    L["交出"] = "Given"
    L["交易对象"] = "Trade Partner"
    L["交易后财产"] = "Money After"
    L["交易前财产"] = "Money Before"
    L["交易选项设置"] = "Trade Settings"
    L["全部角色"] = "All Characters"
    L["确认删除%s的交易记录？"] = "Delete all trade history for %s?"
    L["删除该角色"] = "Delete This Character"
    L["删除该条记录"] = "Delete This Entry"
    L["收到"] = "Received"
    L["搜索交易对象"] = "Search Trade Partners"
    L["天"] = " days"
    L["已删除%s的交易记录。"] = "Deleted trade history for %s."
    L["与<%s>交易成功！%s"] = "Trade with <%s> succeeded! %s"
    L["与<%s>交易失败！"] = "Trade with <%s> failed!"
end

do -- Mail history
    L["%((%d+)个邮件合并%)"] = "%((%d+) mails merged%)"
    L["(%s个邮件合并)"] = "(%s mails merged)"
    L["发件"] = "Sent"
    L["发件(到付)"] = "Sent (COD)"
    L["发送"] = "Sent"
    L["发送金额："] = "Money sent:"
    L["发送物品："] = "Items sent:"
    L["付款取信："] = "COD paid:"
    L["该角色没有该类型的邮件记录。"] = "This character has no mail history of this type."
    L["合并相邻的拍卖行邮件"] = "Merge adjacent auction-house mail"
    L["类型"] = "Type"
    L["没有附件的邮件，也会被显示。"] = "Show mail without attachments."
    L["内容："] = "Body:"
    L["确认删除%s的邮件记录？"] = "Delete all mail history for %s?"
    L["收到金额："] = "Money received:"
    L["收到物品："] = "Items received:"
    L["收件"] = "Received"
    L["收件(到付)"] = "Received (COD)"
    L["显示空邮件"] = "Show empty mail"
    L["显示拍卖行邮件"] = "Show auction-house mail"
    L["相邻的拍卖行邮件会被合并显示为一个邮件，节省空间。"] = "Combine adjacent auction-house messages to save space."
    L["已删除%s的邮件记录。"] = "Deleted mail history for %s."
    L["邮寄后财产"] = "Money After"
    L["邮寄前财产"] = "Money Before"
    L["邮件对象"] = "Correspondent"
    L["邮件记录"] = "Mail History"
    L["邮件类型："] = "Mail type:"
    L["支出金额："] = "Money paid:"
    L["主题"] = "Subject"
    ...
    -- History summary
    L["保存表格时，自动进行汇总"] = "Automatically summarize when saving a table"
    L["查看汇总"] = "View summary"
    L["导出数据"] = "Export data"
    L["跟团"] = "Runs"
    L["工资:(%d+)"] = "Wage:(%d+)"
    ...
    L["合计工资"] = "Total wages"
    L["合计消费"] = "Total spent"
    L["合计消费：%s（%s）"] = "Total spent: %s (%s)"
    L["汇总："] = "Summary:"
    L["仅显示我的角色"] = "Only show my characters"
    L["开始汇总"] = "Start summary"
    L["历史表格汇总"] = "History table summary"
    L["历史表格正在汇总！"] = "Summarizing history tables!"
    L["历史最高价：%s"] = "Historical highest price: %s"
    L["没有数据，请尝试重新汇总。\n如果还是没有，说明你的历史表格里没有合适的数据。"] = "No data. Try rebuilding the summary.\nIf it is still empty, your history tables contain no suitable data."
    L["你不在团队中。"] = "You are not in a raid."
    L["你没有公会。"] = "You are not in a guild."
    L["你没有目标，或者目标不是一名玩家。"] = "You have no target, or your target is not a player."
    L["频道："] = "Channel:"
    L["枪械"] = "Guns"
    L["全部展开"] = "Expand all"
    L["全部折叠"] = "Collapse all"
    L["缺少有效的历史表格数据！"] = "No valid history table data!"
    L["鼠标悬停在玩家时，显示其历史总消费金额和跟团次数"] = "Show historical spending and run count when hovering over a player"
    L["数据汇总完成！"] = "Summary complete!"
    L["搜索玩家或职业"] = "Search player or class"
    L["搜索装备或类型"] = "Search item or type"
    L["——通报历史消费记录——"] = "-- Historical spending records --"
    L["——通报历史总消费排名——"] = "-- Historical spending ranking --"
    L["通报排名"] = "Report ranking"
    L["通报消费记录"] = "Report spending records"
    L["玩家"] = "Player"
    L["玩家：%s"] = "Player: %s"
    L["物品"] = "Item"
    ...
    L["总消费:"] = "Total spent:"
    L["最高价"] = "Highest price"
    L["总消费：|cffffffff"] = "Total spent: |cffffffff"
    L["跟团次数：|cffffffff"] = "Runs: |cffffffff"

    -- Leader announcement history
    L["|cff808080%s|r |cff%s%s|r"] = "|cff808080%s|r |cff%s%s|r"
    L["|cff808080%s|r |cff%s[%s]%s：%s|r"] = "|cff808080%s|r |cff%s[%s]%s: %s|r"
    L["查看团长在公共频道和集结号最近5小时的喊话内容，便于团员核对账单的补贴是否跟喊话一致"] = "View a raid leader's public-channel and Meeting Stone messages from the last five hours to verify advertised subsidies."
    L["导出聊天记录"] = "Export chat history"
    L["喊话记录"] = "Announcement history"
    L["历史喊话"] = "Announcement history"
    L["没有喊话记录。"] = "No announcement history."
    L["没有团长记录。"] = "No raid leader history."
    L["频道过滤："] = "Channel filter:"
    L["删除该团长"] = "Delete this raid leader"
    L["刷新列表"] = "Refresh list"
    L["团长"] = "Raid leader"
    L["团长历史喊话"] = "Raid leader announcement history"
    L["团长历史喊话："] = "Raid leader announcement history:"
    L["系统消息"] = "System messages"
    L["组队"] = "Group"

    -- 批量邮寄工资 (SendMail) 恢复：BGLite 裁剪时删除了该模块的本地化，2026-08-25 从原版 BiaoGe 补回缺失 key
    L["(收件人名字)"] = "(Recipient name)"
    L["{C}，这是你的工资，请查收。\n感谢你参与本次金团活动！^_^\n\n邮件发送时间：{E}"] = "{C}, here are your wages.\nThank you for joining the GDKP run! ^_^\n\nSent: {E}"
    L["|cffff0000批量邮寄被终止。|r\n邮寄人数：%s，已邮寄：%s，未邮寄：%s。"] = "|cffff0000Batch mail was stopped.|r\nRecipients: %s, sent: %s, unsent: %s."
    L["|cffff0000身上金币不够，批量邮寄已停止。|r\n邮寄人数：%s，已邮寄：%s，未邮寄：%s。"] = "|cffff0000Not enough money; batch mail stopped.|r\nRecipients: %s, sent: %s, unsent: %s."
    L["不能给自己邮寄！"] = "You cannot send mail to yourself!"
    L["主题不能为空。"] = "The subject cannot be empty."
    L["你可以在主题和内容里使用变量，系统会把特定字符自动变为对应的数字或文本。"] = "You can use variables in the subject and body. They will be replaced with the corresponding values."
    L["你当前没有团队。"] = "You are not currently in a raid."
    L["使用|cffffffff%s|r作为多个名字的分隔符。"] = "Use |cffffffff%s|r to separate names."
    L["停止"] = "Stop"
    L["关闭"] = "Close"
    L["删除该玩家"] = "Remove this player"
    L["刷新团队框架"] = "Refresh raid list"
    L["发件人名字"] = "Sender name"
    L["变量"] = "Variables"
    L["合计邮寄金额%s %s，你的钱不够。"] = "You do not have enough money for the %s %s total."
    L["合计金额：%s %s"] = "Total: %s %s"
    L["名单："] = "List:"
    L["名字一共|cff00ff00%s|r个"] = "|cff00ff00%s|r names"
    L["回车"] = "New line"
    L["团队成员"] = "Raid members"
    L["实际发送效果："] = "Preview:"
    L["实际效果:"] = "Result:"
    L["导入名单"] = "Import list"
    L["导入当前团队成员名单"] = "Import current raid members"
    L["工资{A}金"] = "Wages {A}g"
    L["已邮寄%s%s金。"] = "Sent %s %sg."
    L["开始批量邮寄"] = "Start batch mail"
    L["批量"] = "Batch"
    L["批量邮寄工资"] = "Batch Mail Wages"
    L["批量邮寄已完成。\n邮寄人数：%s，成功：%s，失败：%s。"] = "Batch mail complete.\nRecipients: %s, succeeded: %s, failed: %s."
    L["提示："] = "Notice:"
    L["收件人名字"] = "Recipient name"
    L["日期和时间"] = "Date and time"
    L["服务器限制同一账号1小时内最多只能邮寄20人。你可以用当前账号邮寄20人，双开用另一个账号邮寄剩下的人。"] = "An account can mail at most 20 different players per hour. Use another account for the remaining recipients."
    L["服务器限制短时间内最多只能给20名不同玩家发送邮件。你当前选择的人数已经超过20人，可能会导致部分玩家邮寄失败。"] = "The server limits mail to 20 different players in a short period. Some selected recipients may fail."
    L["正在批量邮寄：%s/%s"] = "Sending batch mail: %s/%s"
    L["特定字符:"] = "Variable:"
    L["确定开始批量邮寄？"] = "Start batch mail?"
    ...
    L["自定义名单3"] = "Custom list 3"
    L["自定义名单4"] = "Custom list 4"
    L["自定义名单5"] = "Custom list 5"
    L["英文逗号"] = "Comma"
    L["请在右边团队框架选择你要邮寄的对象。"] = "Select recipients from the raid list on the right."
    L["邮寄人数"] = "Recipients"
    L["邮寄人数："] = "Recipients:"
    L["邮寄人数：%s人"] = "Recipients: %s"
    L["邮寄记录"] = "Mail history"
    L["邮寄金额"] = "Mail amount"
    L["邮寄金额不能为0。"] = "The mail amount cannot be 0."
    L["邮寄金额："] = "Amount:"
    L["邮寄金额：%s %s"] = "Amount: %s %s"
    L["金额不能为负数！"] = "The amount cannot be negative!"
    L["（只会导入前40个名字）"] = "(Only the first 40 names will be imported)"

    -- Personal gear score / gear preference
    L["装备偏好"] = "Gear Prefs"
    L["< 装备偏好 >"] = "< Gear Preference >"
    L["设置当前角色的职责、属性偏向和命中门槛，表格与拍卖按此给你算升级分。"] = "Set this character's role, stat bias, and hit caps. The loot table and auctions use these to score upgrades for you."
    L["设置当前角色的职责、属性价值和命中门槛，表格与拍卖按此给你算升级分。"] = "Set this character's role, stat values, and hit caps. The loot table and auctions use these to score upgrades for you."
    L["按职业和当前天赋自动判断职责，无需选择近战、远程或法系。可在此切换天赋，表格与拍卖按此给你算升级分。"] = "Role and damage school are inferred from your class and spec. Switch talent trees here; the loot table and auctions use this to score upgrades."
    L["按职业和当前天赋自动判断职责。分数对比你当前的装备，用来判断性价比，不是全团同一张BIS。"] = "Role comes from your class and spec. Scores compare against your current gear for value, not a raid-wide BiS list."
    L["分数只针对你自己，对比的是你当前穿的装备。缺命中时命中装分高，达标后别人会去抢别的属性。这是性价比，不是全团同一张BIS。"] = "Scores are private and compare against what you are wearing. Hit gear scores high if you are short on hit; once capped, other stats win. This is value, not a raid-wide BiS list."
    L["分数只针对你自己，对比的是你当前穿的装备。白字只是一部分，绿字（命中/暴击/急速/破甲/攻强/法强）经常更值钱。缺命中时命中装分高，达标后别人会去抢别的属性。"] = "Scores are private and compare against what you are wearing. White stats (Str/Agi/Int/Spi) are only part of the score. Green ratings (hit/crit/haste/ArP/AP/SP) are often worth more. Hit gear scores high if you are short on hit."
    L["默认按天赋给出属性价值，用来判断这件对你值不值得加价。可按自己的配装习惯改，改完之后你的升级分就会跟别人不一样。"] = "Defaults follow your spec so you can judge whether a piece is worth bidding on. Change them to match how you gear; your upgrade scores will then differ from other people."
    L["默认按天赋给出属性价值，绿字（命中/暴击/急速/破甲/攻强/法强）按模拟器权重计，往往比白字更值钱。可按自己的配装习惯改。"] = "Defaults follow your spec. Green ratings (hit/crit/haste/ArP/AP/SP) use sim weights and often outvalue white primaries. Change them to match how you gear."
    L["白字"] = "White"
    L["绿字"] = "Green"
    L["装备评分"] = "Gear Score"
    ...
    L["在拍卖竞价窗显示升级分"] = "Show upgrade score on auction bids"
    L["团长开拍时，竞价窗物品名下显示你的推荐升级分。"] = "When the raid leader starts an auction, show your upgrade score to the right of the item name."
    L["团长开拍时，竞价窗物品名右侧显示你的推荐升级分。"] = "When the raid leader starts an auction, show your upgrade score to the right of the item name."
    L["团长开拍时，竞价窗物品名称后面显示你的推荐升级分。"] = "When the raid leader starts an auction, show your upgrade score immediately after the item name."
    L["自身状态"] = "Your stats"
    L["装等"] = "Item level"
    L["达标"] = "Capped"
    L["未达标"] = "Not capped"
    ...
    L["法系"] = "Caster"
    L["主坦"] = "Main tank"
    L["勾选后把防御当作硬门槛。副坦可以取消。"] = "Treat defense as a hard cap. Off-tanks can leave this unchecked."
    L["双持命中帽"] = "Dual-wield hit cap"
    L["近战双持把命中门槛从 8% 改为 27%。"] = "Raise the melee hit cap from 8% to 27% for dual wielding."
    L["法术命中按17%"] = "Spell hit cap 17%"
    L["不勾选时按 14%（团队命中减益）。天赋和种族提供的命中会自动计入。"] = "Unchecked uses 14% (raid hit debuff). Hit from talents and racials is added automatically."
    L["天赋"] = "Talent"
    L["种族"] = "Racial"
    L["偏向"] = "Stat bias"
    L["主偏向"] = "Primary bias"
    L["次偏向"] = "Secondary bias"
    L["无"] = "None"
    L["门槛"] = "Caps"
    L["近战命中"] = "Melee hit"
    L["法术命中"] = "Spell hit"
    ...
    L["当前 %s"] = "Equipped %s"
    L["当前栏位空"] = "Slot empty"
    L["兑换为：%s"] = "Exchanges to: %s"
    L["主堆%s已加权"] = "Primary bias %s is weighted up"
    L["属性"] = "Stats"
    L["属性价值"] = "Stat Values"
    L["自定义属性价值"] = "Custom stat values"
    L["根据您的需求在输入框中输入对应项目的自定义属性价值。"] = "Enter custom EP weights for each stat below."
    L["默认"] = "Default"
    L["自定义"] = "Custom"
    ...
    L["已导入 %d 项属性价值"] = "Imported %d stat values"
    L["没有识别到有效的EP权重"] = "No valid EP weights found"
    L["属性评分"] = "Stat score"
    L["攻强"] = "Attack power"
    L["远程攻强"] = "Ranged AP"
    L["法伤"] = "Spell power"
    ...
    L["远程命中等级"] = "Ranged hit rating"
    L["远程暴击"] = "Ranged crit"
    L["远程急速等级"] = "Ranged haste rating"
    L["格挡"] = "Block"
    L["格挡值"] = "Block value"
    L["点击后按该天赋计算升级分。"] = "Click to score upgrades using this talent tree."
    L["打开装备偏好，调整属性价值和命中门槛。"] = "Open Gear Prefs to adjust stat values and hit caps."
