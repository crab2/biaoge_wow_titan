...
do -- Mail history
    ...
    L["团长开拍时，竞价窗物品名下显示你的推荐升级分。"] = "When the raid leader starts an auction, show your upgrade score under the item name."
    L["自身状态"] = "Your stats"
    L["装等"] = "Item level"
    L["达标"] = "Capped"
    L["未达标"] = "Not capped"
    ...
    L["不勾选时按 14%（常见天赋减 3%）。"] = "Unchecked uses 14% (common 3% talent reduction)."
    L["偏向"] = "Stat bias"
    L["主偏向"] = "Primary bias"
